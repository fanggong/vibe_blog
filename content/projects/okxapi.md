...
An unofficial wrapper for [Okx exchange v5 API](https://www.okx.com/docs-v5/en/). The main purpose is to handle APIs that have limitations on the number of results returned per single request. See [okxAPI](https://cran.r-project.org/web/packages/okxAPI/index.html) for more informations.
## Installation
